  ...
  return (
    <div className='grid'><br /><br /><br />
      ...
      <div className="container center white-text">
        <h3 className='bolder'>An app built for <span className="highlight-container"><span className="highlight">your needs. </span></span> </h3><br />
        ...
        <div className="row">
            <div className="col l3 m6 s12" style={{height: "200px"}}>
              <div className='grid-adjust'>
                    <i className="fa-regular fa-folder-open fa-4x"></i>
            ...
            <div className="col l3 m6 s12" style={{height: "200px"}}>
                <div className='grid-adjust'>
                    <i className="fa-solid fa-clipboard-list fa-4x"></i>
            ...
            <div className="col l3 m6 s12" style={{height: "200px"}}>
                <div className='grid-adjust'>
                      <i className="fa-regular fa-message fa-4x"></i>
            ...
            <div className="col l3 m6 s12" style={{height: "200px"}}>
                <div className='grid-adjust'>
                    <i className="fa-regular fa-bell fa-4x"></i>
