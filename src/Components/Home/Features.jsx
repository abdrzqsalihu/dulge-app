    ...
    <div className='features'><br /><br /><br />
        ...
        <div className="container">
         ...
         <div className="center">
          <h3 className='bolder' style={{lineHeight: "3.5rem"}}><span class="feature-highlight-container"><span class="highlight" style={{paddingRight:"15px"}}>Features</span></span> that work for you </h3><br />
