  ...
  <div className='sidebar hide-on-large-only'>
      ...
      <a href="#mobilemenu" data-target="slide-out" className="sidenav-trigger">
        ...
        <ul id="slide-out" className="sidenav white">  
            ...
            <li>{user?.displayName ? ( <a href="/" className="btn start_btn z-depth-0" onClick={handleSignOut}>Logout</a> ) : (  <Link to="/"  className="btn start_btn z-depth-0">Start for Free</Link>)}</li>   
        </ul>
